...
License:            MIT
Requires:           systemd, cronie, cronie-anacron, perl, perl(LWP::UserAgent), perl(HTTP::Request::Common), perl(XML::Parser::Lite::Tree), perl(Scalar::Util), perl(MIME::Lite), perl(GD::Graph::bars), perl(GD::Graph::Data)
